...
export class NavbarService {
    navbarItems: NavbarItem[] = [
        ...
        new NavbarItem('https://github.com/richlira', 'github', 'fa-brands fa-github', '#584df8d1'),
        new NavbarItem('https://dev.to/richlira', 'devto', 'fa-brands fa-dev secondLine', '#6a6a6a'),
